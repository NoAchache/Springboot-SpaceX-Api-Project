...
public class SpaceXService {
  ...
  public NextLaunchShipDetailsDto getSpaceXShipsDetailsOfNextLaunch(
    NextLaunchDto nextLaunchDto
  )
    throws SpaceXApiException {
    List<String> fairingRecoveryShipsIds = nextLaunchDto
      .getFairings()
      .getShipsIds();
    ...
    List<ShipDetailsDto> fairingRecoveryShipsDetailsDtos = getSpaceXShipsDetails(
      fairingRecoveryShipsIds
    );
    List<ShipDetailsDto> otherShipsDetailsDtos = getSpaceXShipsDetails(
      otherShipsIds
    );
    return spaceXMapper.from(
      nextLaunchDto,
      fairingRecoveryShipsDetailsDtos,
      otherShipsDetailsDtos
    );
  }

  private List<ShipDetailsDto> getSpaceXShipsDetails(List<String> shipIds)
    throws SpaceXApiException {
